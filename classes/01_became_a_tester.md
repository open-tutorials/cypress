...
Нажимаем правой кнопкой мышки в окне приложения, выбираем из меню `Просмотр кода элемента` и видим [Инструменты разработчика Chrome](https://www.youtube.com/watch?v=FStLGMPHSEI)
