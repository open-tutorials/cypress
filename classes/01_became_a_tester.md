...
На самом деле в приложении есть еще один **большооой** баг.

🐞 Кнопка выход не работает, сессия пользователя не закрывается.
...
* **Лог / Log** — журнал выполнения программы на компьютере.
