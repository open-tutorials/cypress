...
Откройте **Markdown** редактор https://markdownlivepreview.com/ и скопируйте в него исходное содержимое [шаблон баг-репорта](../artefacts/bug_report.md)
...
Сделайте вашу доску публичный по ссылке.

Попросите коллег из [сообщества](https://chat.epic1h.com/) в канале `qa_lern` провести ее оценку.
