...
Вас взяли **QA стажером** в стартап в котором разрабатывают инновационное веб-приложение **iBank** https://qa.epic1h.com/
...
**Баг-лист** — это список ошибок со ссылками на снимки экрана или запись видео с экрана.
...
**Баг-репорт** — отчет о несоответствии фактической работы (функционирования) программы и изначальных запланированных требований.
...
Откройте **Markdown** редактор https://dillinger.io/ и скопируйте в него исходное содержимое [шаблон баг-репорта](../artefacts/bug_report.md)
...
<details>
   <summary>Исправленная версия приложения</summary>

Откройте в новой вкладке https://qa.epic1h.com/?v=1.1
...
**Лучшая практика:** интерфейс пользователя не компрометировать пользователя.

</details>

# 🤩 Что дальше?

Найдите ошибки, добавьте скриншоты или запись экрана для баг-листа:
...
14. 🐞 На сматрфоне форма входа обрезается

Оформите баги в баг-трекере и отсортируйте карточки по приоритетам.
