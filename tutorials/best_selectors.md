...
**Селекторы / локаторы** — позволяют **находить элементы** пользовательского интерфейса с которыми вы хотите **
заставить** машину взаимодействовать.

Селекторы — **основная часть** будущего **исходного кода** ваших тестов.

От того, **насколько хорошо** вы будете **находить селекторы** элементов, ваш код будет:
