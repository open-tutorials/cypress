...
Правильная версия https://www.epic1h.com/fake_data
</md-hidden>
...
> Если в тест можно добавить **вариативности** не нарушив его **стабильность** — лучше это сделать.
...
Напишем тест-кейс удаления статьи:
