...
Уже совсем скоро, именно с помощью это команды, ты будешь запускать свои тесты на своем сервере!
...
Тесты всегда будут ломаться. Ты должен уметь искать причины падений и исправлять их.
