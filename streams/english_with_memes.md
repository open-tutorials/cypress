...
<img src="assets/../../assets/memes_teach/load_vocabulary.png">

### Learn word

<img src="assets/../../assets/memes_teach/learn_word.png">
...
По юзуер-стори и варефрейму фича выглядит не сложно.

Пользователю можно предложить загружать свой словарь в виде текста:
...
Предложим ввести ему его в текстовое поле на форме. 
...
Что делать с мемом? Откуда его брать?
...
<img src="assets/../../assets/memes_teach/giphy_embed.png">
...
Ответ мы видим в JSON, я форматнул [тут](https://jsonformatter.curiousconcept.com/) для наглядности.

Что-то мне подсказывает, что это то, что мы ищем.

<img src="assets/../../assets/memes_teach/giphy_json.png">

По сути нам нужно взять `embed_url` и подсунуть его в свойство `src` фрейма внутри HTML.
...
Весь процесс разработки я рассмотрел на стриме. Не забывай использовать тайм-коды.
...
Хочешь продолжить? Вот тебе домашка:
