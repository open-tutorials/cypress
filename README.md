...
2. Обновить маму до Cypress 11
3. Собираем мама проект локально
4. Деплоим маму на своем сервере
5. Запускаем тестирование по расписанию через CI/CD в GitLab
6. Визуальное тестирование через Cypress
7. Тестирование API в Cypress
