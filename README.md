...
* Напишем автотест на подписку на рассылку `Cypress`
...
<details>
  ...
  Создавайте файл `test.js` с содержимым `console.log(new Date().toISOString());`

  Потом выполните команде `node test.js`
