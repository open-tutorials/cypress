...
```
Всем привет! Очень нужен профессиональный совет. Мне как джуну дали сложное тестовое задание, дайте пожалуйста рекомендацию, на что нужно обратить внимание, с чего начать. Как бы Вы стали решать такую задачу? Так как задача из разряда для Middle, как по мне. Буду очень благодарен каждому, кто откликнется. Заранее спасибо!

Задача - написать работу о процессе, который вы бы предложили для введения
обеспечения качества продукта. 

Есть некоторая информация, которую мы должны принять во внимание
прежде чем мы предложим этот процесс клиенту:
- Продукт представляет собой мобильное приложение для рынка Великобритании.
- Приложение находится в разработке уже около 7 месяцев. Мы
планируем выпустить приложение в производство через 2-3 месяца.
- Команда состоит из владельца продукта - бизнесмена из Великобритании, двух backend Node.js разработчиков и двух frontend React Native разработчиков. Также в команде есть
дизайнер, который частично помогает в планировании объема работ.
- Команда работает по методологии Agile. Они стараются планировать объем задач на
две недели.
- Есть дизайн в Figma, некоторые экраны устарели.
- Система управления задачами, используемая для продукта, - Trello. Некоторые требования
можно найти там.
- Документации по тестированию, естественно, нет. 
- Надлежащее тестирование продукта не проводилось. Обычно разработчики проверяли
то, что они внедрили, и исправляли ошибки, найденные владельцем продукта.

Что вы можете предложить в этой ситуации, чтобы подготовить приложение к релизу. Опишите шаги, действия и инструменты, которые вам помогут.
```
